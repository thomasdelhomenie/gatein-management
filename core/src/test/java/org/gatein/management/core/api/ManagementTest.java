...
{
   protected static ManagedResource rootResource()
   {
      return new SimpleManagedResource(null, null, description("Root resource"));
   }

   protected static <T extends ManagedResource> T rootResource(Class<T> as)
   {
      return as.cast(rootResource());
   }

   protected static PluginContext pluginContext(ManagedResource managedResource)
   {
      return new PluginContextImpl((SimpleManagedResource) managedResource, new PluginsMarshallerRegistrar());
   }
